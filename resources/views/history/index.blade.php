<x-admin-layout>
    ...
    <div class="history-list">
                ...
                <div class="history_card">
                    ...
                    <div class="body">
                        ...
                        <div class="bottom-info">
                            ...
                            <span class="additional_info"><i class="fa-solid fa-floppy-disk"></i> Autoshast</span>
                        </div>
        ...
        @if ($lastDate != $currentPost->updated_at->format('Y-m-d'))
            ...
            @else
                <div class="date">
                    Changes with {{ \Carbon\Carbon::parse($currentPost->updated_at)->translatedFormat('d F, Y') }}
                    <div class="line-v"></div>
                </div>
            @endif
        @else
