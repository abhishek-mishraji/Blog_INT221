                ...
                <tbody class="body_user_list">
                    @foreach ($categories as $category)
                        <tr>
                            ...
                            <td data-label="Tło">{{ $category->backgroundColor }} <span class="box"
                                    style="background: {{ $category->backgroundColor }};"> </span> </td>
                            <td data-label="Kolor">{{ $category->textColor }} <span class="box"
                                    style="background: {{ $category->textColor }};"> </span> </td>
                            <td data-label="Podgląd"><span class="preview"
                                    style="background: {{ $category->backgroundColor }}CC; color: {{ $category->textColor }};">{{ $category->name }}
                                </span> </td>
                            <td data-label="Ilość postów">{{ $category->posts_count }} </td>
                            <td data-label="Akcje">
                                @can('category-edit')
                                    <a href="{{ route('categories.edit', $category->id) }}" class="edit"><i
                                ...
                                @can('category-delete')
                                    ...
                                    <button onClick="confirmDelete({{ $category->id }}, 'category')" class="delete"><i
